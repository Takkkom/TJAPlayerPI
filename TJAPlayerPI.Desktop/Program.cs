        ...
        static void Main(string[] args)
        {
            ...
            if (mutex.WaitOne(0, false))
            {
                    ...
                    Dictionary<string, string> errorjsonobject = new Dictionary<string, string>
                {
                    ...
                    { "SkinName", TJAPlayerPI.SkinName },
                    { "SkinVersion", TJAPlayerPI.SkinVersion },
                    { "SkinCreator", TJAPlayerPI.SkinCreator },
                    { "Renderer", TJAPlayerPI.Renderer },
